...
namespace Walnut {
	...
	void Application::Init()
	{
		...
		if (!m_Specification.IconPath.empty()) {
			GLFWimage icon = {};
			icon.pixels = stbi_load(m_Specification.IconPath.c_str(), &icon.width, &icon.height, NULL, 0);
		...
		ImFont* robotoFont = io.Fonts->AddFontFromMemoryTTF((void*)g_RobotoRegular, sizeof(g_RobotoRegular), 30.0f, &fontConfig);
